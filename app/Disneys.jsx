...
export default function Disneys({ disneys }) {
    return (
        <>
            <ul className="grid grid-cols-1 mx-auto max-w-[1260px] gap-20">
                {disneys.map((disney) => (
                    <li key={disney.movieID} className="flex flex-col items-center mb-4 border border-white p-4">
                        <div className="flex items-center justify-center">
                            <Image
                                src={disney.image}
                                alt={disney.title}
                        ...
                        <div className="mt-4">
                            <p className="text-xl font-bold">{disney.title}</p>
                            {/* Additional information */}
                            <p className="text-gray-500">{disney.summary}</p>
                        </div>
                    </li>
                ))}
            </ul>
